...
# with command line options: step3-valid -s HARVESTING:@trackingOnlyValidation --no_exec --python_filename step3-valid_cfg.py --conditions auto:phase2_realistic_T35 --mc
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step3-valid_RECO.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3-valid nevts:1'),
...
# Schedule definition
process.schedule = cms.Schedule(process.postValidation_trackingOnly_step,process.dqmsave_step)
